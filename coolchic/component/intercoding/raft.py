...
from coolchic.io.format.yuv import convert_420_to_444, rgb2yuv, yuv2rgb
from coolchic.io.framedata import FrameData
from coolchic.training.loss import _compute_mse


@torch.no_grad()
def get_raft_optical_flow(frame_data: FrameData, ref_data: List[FrameData]) -> List[torch.Tensor]:
