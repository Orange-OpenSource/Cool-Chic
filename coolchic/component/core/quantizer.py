...
def generate_kumaraswamy_noise(uniform_noise: Tensor, kumaraswamy_param: Tensor) -> Tensor:
    """
...
def quantize(
    ...
    Args:
        ...
        quantizer_noise_type: noise type. Defaults to ``"gaussian"``.
        ...
        soft_round_temperature: Soft round temperature. This is used for
            ...
            the backward. Defaults to None.
        noise_parameter: noise distribution parameter. Defaults to None.
