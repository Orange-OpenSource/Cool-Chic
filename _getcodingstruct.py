...
if __name__ == "__main__":
    ...
    # ----- CodingStructure parameters, copy of cc_encode.py args
    parser.add_argument(
        "--intra_pos",
    ...
    parser.add_argument(
        "--job_dependency", help="Print slurm job dependencies", action="store_true"
    )

    parser.add_argument(
        "--raw_coding_struct",
        help="Print raw coding structure in a tsv-like format",
        action="store_true",
    )
